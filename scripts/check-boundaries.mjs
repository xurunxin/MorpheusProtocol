...
assert(protocolPackage.version === "0.6.2", "unexpected Protocol version");
assert(
...
assert(
  JSON.stringify(sdkPackage.dependencies) ===
    JSON.stringify({ "@xurunxin/morpheus-protocol": "0.6.2" }),
  "SDK must depend only on exact @xurunxin/morpheus-protocol@0.6.2",
);
